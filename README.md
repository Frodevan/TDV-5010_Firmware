...
The version used in most production keyboards of this type, and usually found with a one-time-programmable ROM based mass-produced 80C51. Dumped from a keyboard made in week 45 of 1992, and controller is a P-80C51 AEY from MHS. This version has also been found in a P-80C51 BAP from MHS dated the 9th week of 1994.

* Uses a dedicated flag to disable scanning, rather than disabling the clock interrupts themselves.
